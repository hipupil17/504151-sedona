...
* Студент: [Никита Потапов](https://up.htmlacademy.ru/htmlcss/18/user/504151).
* Наставник: `Катеритна Шелег`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/504151-sedona) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
